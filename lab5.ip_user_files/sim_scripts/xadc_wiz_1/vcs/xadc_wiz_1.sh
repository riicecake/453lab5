...
reset_run()
{
  files_to_remove=(ucli.key xadc_wiz_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc xadc_wiz_1_simv.daidir vcs_lib c.obj)
