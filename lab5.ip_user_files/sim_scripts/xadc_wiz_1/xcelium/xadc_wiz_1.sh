...
#
# Script generated by Vivado on Thu Oct 17 08:30:31 -0600 2024
...
#
# Usage        : xadc_wiz_1.sh
#                xadc_wiz_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xadc_wiz_1.sh [-reset_run]
#                xadc_wiz_1.sh [-reset_log]
#                xadc_wiz_1.sh [-help]
#
...
#                script (type 'xadc_wiz_1.sh -help' for more information).
#
...
# script info
echo -e "xadc_wiz_1.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xadc_wiz_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.xadc_wiz_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.xadc_wiz_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log xadc_wiz_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: xadc_wiz_1.sh [-step]\n\
Usage: xadc_wiz_1.sh [-lib_map_path]\n\
Usage: xadc_wiz_1.sh [-reset_run]\n\
Usage: xadc_wiz_1.sh [-reset_log]\n\
Usage: xadc_wiz_1.sh [-keep_index]\n\
